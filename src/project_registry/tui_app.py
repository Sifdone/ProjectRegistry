    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(id="tmpl-edit-box"):
            ...
            with ScrollableContainer(id="tmpl-edit-scroll"):
                ...
                yield Label("Director", classes="field-label")
                yield Input(value=self._template.get("director") or "", placeholder="e.g. BBDO (optional)", id="tmpl-director")
                yield Label("Producer", classes="field-label")
                yield Input(value=self._template.get("producer") or "", placeholder="e.g. Claudia (optional)", id="tmpl-producer")
